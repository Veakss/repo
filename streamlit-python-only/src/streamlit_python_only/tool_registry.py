...
from streamlit_python_only.tooling import ToolDefinition, build_tool_definitions
...
class RegisteredTool:
    ...
    def metadata(self) -> dict[str, object]:
        return {
            "supports_thales": self.definition.supports_thales,
            "supports_native_tools": self.definition.supports_native_tools,
            "supports_textual_replay": self.definition.supports_textual_replay,
            "returns_evidence_kind": self.definition.returns_evidence_kind,
        }
